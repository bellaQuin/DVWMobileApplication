...
public class Goal_Question_1 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goal_1_edit_text.addTextChangedListener(inputText);
        goal_question_1_btn = findViewById(R.id.btn_goal_question_1);
    ...
    private TextWatcher inputText = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            String answer = goal_1_edit_text.getText().toString().trim();

            if(answer.length() >= 4)
            {
                goal_question_1_btn.setVisibility(View.VISIBLE);
