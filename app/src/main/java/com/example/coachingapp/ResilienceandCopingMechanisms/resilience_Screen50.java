...
public class resilience_Screen50 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void btn_Recognise(View view) {
        Intent intent = new Intent(resilience_Screen50.this, Slide_11.class );
        startActivity(intent);
    }

    public void btn_Response(View view) {
        Intent intent = new Intent(resilience_Screen50.this, Slide_14.class );
        startActivity(intent);
    }

    public void btn_Resolve(View view) {
        Intent intent = new Intent(resilience_Screen50.this, resilience_Screen39.class );
        startActivity(intent);
    }
