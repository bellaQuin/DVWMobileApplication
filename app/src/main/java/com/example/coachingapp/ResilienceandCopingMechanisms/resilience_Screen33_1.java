...
public class resilience_Screen33_1 extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r_screen_33_1_btn_next = findViewById(R.id.r_screen_33_1_btn_next);
    ...
    private TextWatcher inputText = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            if(answer.length() >= 2)
            {
                r_screen_33_1_btn_next.setVisibility(View.VISIBLE);
