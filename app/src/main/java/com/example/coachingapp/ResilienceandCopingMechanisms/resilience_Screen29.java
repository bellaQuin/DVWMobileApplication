...
public class resilience_Screen29 extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rGpTnext2 = findViewById(R.id.r_screeb_29_btn_next);
...
//            myRef.child("users").child(id).push().setValue(issues);
    ...
    private TextWatcher inputText = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            if(answer.length() >= 2)
            {
               rGpTnext2.setVisibility(View.VISIBLE);
