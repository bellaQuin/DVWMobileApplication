...
import com.example.coachingapp.Models.Innerthought;
...
public class Slide_12_Innerthoughts extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void addToFirebase() {
        ...
        if (user != null) {
            ...
            for (CheckBox checkBox: checkBoxes)
            {
                ...
                Innerthought  innerthought = new Innerthought(options);
                String id = user.getUid();
                myRef.child("users").child(id).child("Resilience").child("resilience_11").setValue(innerthought);
